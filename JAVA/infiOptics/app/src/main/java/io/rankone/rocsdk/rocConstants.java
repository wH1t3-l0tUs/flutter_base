...
public interface rocConstants {
  ...
  public final static float ROC_SUGGESTED_MIN_QUALITY = rocJNI.ROC_SUGGESTED_MIN_QUALITY_get();
  public final static float ROC_NO_MIN_QUALITY = rocJNI.ROC_NO_MIN_QUALITY_get();
  public final static SWIGTYPE_p_f_p_void_p_q_const__char_roc_image__void roc_tracker_add_image_callback = new SWIGTYPE_p_f_p_void_p_q_const__char_roc_image__void(rocJNI.roc_tracker_add_image_callback_get(), false);
  public final static SWIGTYPE_p_f_p_void_p_q_const__char_roc_image__void roc_tracker_add_template_callback = new SWIGTYPE_p_f_p_void_p_q_const__char_roc_image__void(rocJNI.roc_tracker_add_template_callback_get(), false);
}
