...
//
//        if (!StringUtils.isEmpty(SharedPfPermissionUtils.getColorTheme(context))) {
////            int color = Color.parseColor(SharedPfPermissionUtils.getColorTheme(context));
//            int color = Color.parseColor("#04B7FF");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (actionMasked) {
            case MotionEvent.ACTION_DOWN: {
                ...
                //预设100ms进入拖动状态
                postDelayed(postPendingDrag, 500);
                break;
            }
