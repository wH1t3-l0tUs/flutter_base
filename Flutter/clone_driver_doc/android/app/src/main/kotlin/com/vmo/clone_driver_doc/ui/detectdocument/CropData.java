...
public class CropData extends Corners {
	...
	void setOrientation(int value) {
		if (value != orientation) {
			...
			// to documents orientation. To change corners orientation we must first transform corners
			// back to original image and next translate to new orientation

			Matrix m = buildOrientationMatrix(orientation);

			// Store documents bounds: translate native image bounds to current orientation
