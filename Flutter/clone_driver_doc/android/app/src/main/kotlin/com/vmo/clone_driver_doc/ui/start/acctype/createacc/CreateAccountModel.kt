...
class CreateAccountModel(appDatabase: AppDatabase, interactCommon: InteractCommon, schedulers: Executor) :
        BaseViewModel<CreateAccountCallBack>(appDatabase, interactCommon, schedulers) {
