package io.driverdoc.testapp.ui.detectdocument.camera;
...
import io.driverdoc.testapp.ui.detectdocument.AppLog;
import io.driverdoc.testapp.ui.detectdocument.AppSdkFactory;
import io.driverdoc.testapp.ui.detectdocument.SdkFactory;
import io.driverdoc.testapp.ui.detectdocument.util.ParcelableHolder;
import io.driverdoc.testapp.ui.detectdocument.util.RuntimePermissions;
import io.driverdoc.testapp.ui.detectdocument.util.Utils;
import io.driverdoc.testapp.ui.detectdocument.widget.ImageCheckBox;
import io.driverdoc.testapp.ui.detectdocument.widget.console.ConsoleView;
...
public class CameraActivity
    ...
    /**
     * Detect and show documents corners
     */
    ...
    private AppCompatImageView ivCapture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivCapture = (AppCompatImageView) findViewById(R.id.iv_capture);
        ...
        ivCapture.setOnClickListener(mClickListener);
...
//            takePicture(params, false);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        MVVMApplication.Companion.getLiveData().postValue(9);
    }
}
