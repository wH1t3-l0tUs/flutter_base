...
import io.driverdoc.testapp.data.model.login.VerifiCodeRequest
...
class VerifiModel(appDatabase: AppDatabase, interactCommon: InteractCommon, schedulers: Executor) :
        BaseViewModel<VerifiCallBack>(appDatabase, interactCommon, schedulers) {
    private val restApi: RestApi
    val obVerifi = MutableLiveData<VerifiCodeRespone>()
        get
    ...
    fun verifiCode(countryCode: String, phoneNumber: String, code: String, osVersion: String, ip: String) {
        val request = VerifiCodeRequest()
        request.code = code
